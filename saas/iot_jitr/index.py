...
THING_GROUP_NAME = os.environ.get('THING_GROUP_NAME', 'IoTDR-JITR_Thing_Group')
ERRORS = []
...
def add_thing_to_thing_group(c_iot, thing_name, thing_group_name):
    global ERRORS
    try:
        logger.info('thing_name: {} thing_group_name: {}'.format(thing_name, thing_group_name))
        ...
        logger.error("add_thing_to_thing_group: {}".format(e))
        ERRORS.append("add_thing_to_thing_group: {}".format(e))
...
def lambda_handler(event, context):
    ...
    try:
        ...
        add_thing_to_thing_group(c_iot, thing_name, THING_GROUP_NAME)
    except Exception as e:
